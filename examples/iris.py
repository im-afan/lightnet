import pandas as pd
import numpy as np
from lightnet import core, grads, activations, losses
import matplotlib.pyplot as plt

weight1 = core.FeedForward(np.random.uniform(size=(4, 10)), np.random.uniform(size=(10,)), activations.Tanh())
weight2 = core.FeedForward(np.random.uniform(size=(10, 10)), np.random.uniform(size=(10,)), activations.Tanh())
#weight3 = core.FeedForward(np.random.uniform(size=(10, 10)), np.random.uniform(size=(10,)), activations.Tanh())
weight4 = core.FeedForward(np.random.uniform(size=(10, 3)), np.random.uniform(size=(3,)), activations.Sigmoid())
